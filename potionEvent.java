...
public void execute(Player player, Scanner scanner) {
    ...
    System.out.println("\nIn the heart of the kingdom, you stumble upon the Grand Apothecary's alchemy shop. " + 
            ...
            System.out.println("\nThe Grand Apothecary senses your strength and determination and hands you a weatherd map, pinpointing the exact location of the cave and asks you to aquire the herb for him. " +
            ...
            "He gives you a silent nod and begins tro instruct you in the art of potion-making. Together, they brewed a concoction that held the essence of the Haloe Waera. " + 
