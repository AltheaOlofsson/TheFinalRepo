...
public class MenuController {
    ...
    public Player selectOption() {
        ...
        switch (menuChoice) {
            ...
            case "1":
                clearScreen();
                // beginStory();
                String name = inputName(userInput);
    ...
    public void beginStory() throws InterruptedException {
        ...
        Thread.sleep(1000);
        System.out
                .println("This is an era of Monsters, Beasts and Badmen. These lands are ridden with fear and strife.");
        Thread.sleep(3000);
        ...
        Thread.sleep(3000);
        System.out
                .println("You then made the decision that adventuring was a bigger endavour worthy of your commitment");
        Thread.sleep(3000);
